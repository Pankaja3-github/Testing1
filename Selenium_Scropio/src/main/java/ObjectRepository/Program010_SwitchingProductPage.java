...
public class Program010_SwitchingProductPage {
	public Program010_SwitchingProductPage(WebDriver driver)
	{
	...
	{
		WebElement prodName = driver.findElement(By.xpath("//a[text()='" + PrdName + "']"));
		prodName.click();
	}
